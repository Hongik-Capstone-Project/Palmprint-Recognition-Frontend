 ...
 */
@Composable
internal fun DeleteInstitutionContent(
    ...
    RootLayoutWeighted(
        ...
        body = {
            DeleteInstitutionMessageSection(
                modifier = Modifier
                    .fillMaxWidth()
        ...
        footer = {
            Footer {
                DeleteInstitutionActionSection(
                    uiState = uiState,
...
@Composable
private fun DeleteInstitutionMessageSection(
    modifier: Modifier = Modifier
) {
    Box(
...
@Composable
private fun DeleteInstitutionActionSection(
    uiState: UiState<Unit>,
    onYesClick: () -> Unit,
    onNoClick: () -> Unit,
    modifier: Modifier = Modifier
    ...
    Column(
        ...
        when (uiState) {
            ...
            is UiState.Error -> {
                Text(text = uiState.message ?: "인증기관 삭제 중 오류가 발생했습니다.")
                VerticalTwoButtons(
                    firstText = "다시 시도",
                    secondText = "아니오",
                    onFirstClick = onYesClick,
...
@Composable
private fun PreviewDeleteInstitutionContent() {
    DeleteInstitutionContent(
